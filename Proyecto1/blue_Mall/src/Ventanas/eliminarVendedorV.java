...
import static Ventanas.ControlarDatos.eliminarVendedorCD;
...
public class eliminarVendedorV extends JFrame implements ActionListener {

    //Se crean los labels
    JLabel l1, l2;

    //Se crean los botones
    JButton eliminarVendedor;

    //Se crea la caja de texto
    JTextField t1;

    public eliminarVendedorV() {
        //Colocandole fuente a los labels
        Font fuenteNueva = new Font("ARIAL", Font.BOLD, 30);
        Font fuentecodigo = new Font("ARIAL", Font.BOLD, 15);

        l1 = new JLabel("Eliminar Vendedor");
        ...
        eliminarVendedor.setBounds(105, 130, 150, 30);
