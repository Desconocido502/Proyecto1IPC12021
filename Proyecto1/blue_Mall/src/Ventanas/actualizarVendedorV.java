...
import static Ventanas.ControlarDatos.actualizarVendedorCD;
...
public class actualizarVendedorV extends JFrame implements ActionListener {
    ...
    JButton actualizarVendedor;

    public actualizarVendedorV() {
        Font fuenteNueva = new Font("ARIAL", Font.BOLD, 35);
        Font fuenteNueva2 = new Font("ARIAL", 0, 17);

        l1 = new JLabel("Actualizar Vendedor");
        ...
        //actualiza al(a) vendedor(a)
        actualizarVendedor = new JButton("Actualizar");
        actualizarVendedor.setBounds(430, 460, 150, 40);
    ...
    public void actionPerformed(ActionEvent ae) {
        String[] vendedor_a_actualizar = new String[5];
        String codigo = "";
        String nombre = "", caja = "", ventas = "", genero = "";
        codigo = t1.getText();
        nombre = t2.getText();
        caja = t3.getText();
        ventas = t4.getText();
        ...
        if (ae.getSource() == actualizarVendedor) {
            if (codigo.equals("0") || nombre.equals("") || caja.equals("") || ventas.equals("") || genero.equals("")) {
                JOptionPane.showMessageDialog(this, "No se han ingresado todos los valores o ninguno de ellos!, ingrese los valores");
            } else {
                vendedor_a_actualizar[0] = codigo;
                vendedor_a_actualizar[1] = nombre;
                vendedor_a_actualizar[2] = caja;
                vendedor_a_actualizar[3] = ventas;
                vendedor_a_actualizar[4] = genero;

                actualizarVendedorCD(vendedor_a_actualizar);
